  ...
  <Layout>
    ...
    <section className="container">
      ...
      <div className="text text-links">
        ...
        <h3>React:</h3>
        <p>
          <a href="https://habrahabr.ru/post/309422/">Паттерны React</a>
        </p>
        <h3>Typescript:</h3>
        <p>
        ...
        <h3>CSS:</h3>
        <p>
          <a href="http://css.yoksel.ru/pages/css-selectors/">all selectors</a>
        </p>
        <h3>Different:</h3>
        <p>
          <a href="https://github.com/knsv/mermaid">
            Generation of diagram and flowchart from text in a similar manner as
            markdown
          </a>
        </p>
        <h3>Test:</h3>
        ...
        <p>
          <a href="http://cmder.net/">http://cmder.net/</a>
        </p>
        <h3>Animations:</h3>A
        <p>
        ...
        <h4>Software</h4>
        <p>
          <a href="https://www.jetbrains.com/phpstorm/eap/">
            https://www.jetbrains.com/phpstorm/eap/
          </a>
        </p>
        <h3>GDPR по-русски</h3>
        <p>
          <a href="https://habr.com/post/353532/">1</a>
        </p>
        <p>
          <a href="https://habr.com/post/359014/">2</a>
        </p>
        <p>
          <a href="https://habr.com/post/359180/">3</a>
        </p>
        <h2>#Netherlands</h2>
        ...
        <p>
          <a href="https://www.eigenhaard.nl/">https://www.eigenhaard.nl/</a>
        </p>
      </div>
    </section>
  </Layout>
